  ...
  <body>
    <div class="row" style="  background: -webkit-linear-gradient(left, #25b7c4, #845ddf);
        ...
        <div class="col-sm-2">
            ...
            onclick="window.print()">
              ...
              <button type="button" class="btn btn-lg btn-info active" style="position: relative;
                 height: 45px; width: 90px; margin-top: 5%;">
                    <a href="../Home/finalmainPlanner.jsp" style="color:#ffffff; margin-bottom: 0px; 
                    font-size: 18px; text-decoration: none;">Back</a>
                </button>  
        </div>
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            border-width: 18px;">
                <h2>Increase: 5%   <span style="color:rgb(31, 219, 31); font-size: 38px;">&#8599;</span></h2>
            </div>
            <div class="col-sm-1"></div>
            <div class="col-sm-2" style="border-style:inset; border-color:#25b7c4;
            border-width: 18px;">
                <h2>Decrease: 32%   <span style="color:rgb(241, 55, 55); font-size: 38px;">&#8600;</span></h2>
            </div>
            <div class="col-sm-1"></div>
            <div class="col-sm-2" style="border-style:inset; border-color:#25b7c4;
            border-width: 18px;">
                 <h2>Increase: 8,6%   <span style="color:rgb(31, 219, 31); font-size: 38px;">&#8599;</span></h2>
            </div></div>
