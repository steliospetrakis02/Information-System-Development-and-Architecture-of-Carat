  ...
  <body>
    <div class="testbox">
      <form action="/">
        ...
        <div class="colums">
          <div class="item">
            <p style="font-size: 28px;"><b>Company: Aegean</b></p>
          </div>
          <div class="item">
            <p style="font-size: 23px;">Send the new password to aegean@gmail.com</p>
          </div>
          <div class="colums">
            <div class="item">
              <label for="fname">Enter old Password<span>*</span></label>
              <input id="fname" type="text" name="fname" required/>
            </div>
            <div class="item">
              <label for="lname">Enter new Password <span>*</span></label>
              <input id="lname" type="text" name="lname" required/>
            </div>
            <div class="item">
              <label for="address1">Confirm new Password <span>*</span></label>
              <input id="address1" type="text"   name="address1" required/>
            </div>
            <div class="item">
                <a type="submit"  href="" style="text-decoration: none; font-size: 20px;" 
              class="button2">Submit</a>
            </div>
