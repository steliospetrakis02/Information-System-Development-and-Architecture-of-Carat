...
<link rel="stylesheet" href="../../CSS/Home/contact.css" media="screen">
...
</li><li class="u-nav-item"><a class="u-active-custom-color-2 u-border-active-palette-1-base u-border-hover-palette-1-light-1 u-button-style u-custom-color-1 u-hover-white u-nav-link u-text-active-white u-text-grey-90 u-text-hover-grey-90" href="contact.jsp" style="padding: 10px 20px;">contact</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="contact.jsp">contact</a>
...
borders: top right bottom left !important
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-141d">
        ...
        <div class="u-form u-form-1">
          <form action="" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 10px" source="email" name="form">
            ...
            <div class="u-form-email u-form-group u-label-none">
              ...
              <input type="email" id="email-3b9a" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="" placeholder="Enter your e-mail address">
            </div>
