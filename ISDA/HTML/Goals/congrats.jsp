...
<style>
	.button {
	  ...
	  .button {
		...
		<div class="text">
		<p>You have successfully set your goals for this Year. <br>Here are your details<br>Date: 12.12.12<br>
			Time: 11am<br>
			ID: 12324
		</p>
			</p>
			</div>
		<p class="regards">Regards, Team Carat </p>
		<form action="../../HTML/Home/finalmain.html">
