...
borders: top right bottom left !important
    ...
    <section class="u-clearfix u-section-1" id="sec-e51b">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="center u-clearfix u-custom-html u-custom-html-1">
          <meta charset="UTF-8">
          <title></title>
          ...
          <div class="login-form">
            <form name="myForm">
              <h1 style="color:rgb(85, 79, 192)"><b>Congratulations</b></h1>
              <div class="texting">
              <p><b>You have successfully recovered your password</b></p>
              </div>
              <div class="action">
                <button type = "submit"><a href = "login.jsp" style="text-decoration: none; color: black">Login with your new password</a></button>
              </div>
            </form>
          </div>
